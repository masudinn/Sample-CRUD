<?php
  include('conf.php'); //agar index terhubung dengan database, maka koneksi sebagai penghubung harus di include
...
<html>
  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT * FROM jualbeli ORDER BY id ASC";
      ...
      ?>
       <tr>
          ...
          <td>Rp <?php echo number_format($row['beli_produk'],0,',','.'); ?></td>
          <td>Rp <?php echo $row['jual_produk']; ?></td>
