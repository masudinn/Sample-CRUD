<?php
  // memanggil file db.php untuk membuat db
include 'conf.php';
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM jualbeli WHERE id='$id'";
  ...
  <body>
      ...
      <section class="base">
        ...
        <label>Harga Beli</label>
         <input type="text" name="beli_produk" required=""value="<?php echo $data['beli_produk']; ?>" />
        </div>
        <div>
          <label>Harga Jual</label>
         <input type="text" name="jual_produk" required="" value="<?php echo $data['jual_produk']; ?>"/>
        </div>
        <div>
